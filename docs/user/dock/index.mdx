...
In either auto-hide mode, pointer-triggered reveal requires keeping the pointer on the edge trigger strip for 250 ms. Briefly crossing the edge does not reveal it.
